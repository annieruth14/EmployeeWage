public class EmployeeWageBuilder{
	...
	public EmployeeWageBuilder (String company, int empRate, int no_of_days, int max_hrs){
	...
	public static void main (String[] args){
		EmployeeWageBuilder Capg = new EmployeeWageBuilder("Capgemini",20,3,8);
		EmployeeWageBuilder Rel = new EmployeeWageBuilder("Reliance",30,2,11);
		Capg.calEmpWage();
		Rel.calEmpWage();
